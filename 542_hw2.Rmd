...
bitcoin <- read.csv(file="C:/Users/yantongz/Desktop/542/bitcoin_dataset.csv", sep=",",  header=TRUE, colClasses=c("Date", rep("numeric", 23)), na.strings = " ")
...
Q2
Part I
On piazza, the instructor says we can ignore the column with missing data for question 2 as well, so I will keep using "bitcoin1" from Q1.  

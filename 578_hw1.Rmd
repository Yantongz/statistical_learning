...
```{r, echo=FALSE}
full_data <- read.delim("C:/Users/yantongz/Desktop/578/hw/ml-100k/u.data", header=FALSE, stringsAsFactors=FALSE, col.names = c("user_id", "item_id", "rating", "timestamp" ))
...
movie_item <- read_delim("C:/Users/yantongz/Desktop/578/hw/ml-100k/u.item", "|", escape_double = FALSE, col_names = FALSE, col_types = cols(X3 = col_date(format = "%d-%b-%Y"), 
...
user <- read_delim("C:/Users/yantongz/Desktop/578/hw/ml-100k/u.user", 
...
data_folder <- "C:/Users/yantongz/Desktop/578/hw/ml-100k"
